 ...
 * 
 */
@WebServiceClient(name = "PagosService", targetNamespace = "http://boundary.pagos.modval.aes.javeriana.edu.co/", wsdlLocation = "http://130.211.116.156/gas-service/PagosService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://130.211.116.156/gas-service/PagosService?wsdl");
